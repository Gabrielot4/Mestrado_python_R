...
quiqua <- chisq.test(data_cod$valor_cod, predict(mymodel))      # associação entre variáveis categóricas
...
write_xlsx(data_cod, "D:\\15.1 Mestrado - ATUALIZADO\\1.0 - Dissertação de mestrado\\2. python_mestrado\\base_regressao_logistica3_R.xlsx")
