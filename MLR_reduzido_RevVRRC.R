...
mymodel <- multinom(Valor_pago_red ~., data = data, model = TRUE)               # valor_pago_red ~. : valor_pago_red é a dependente e ~. significa que todas as outras colunass são as independtens
